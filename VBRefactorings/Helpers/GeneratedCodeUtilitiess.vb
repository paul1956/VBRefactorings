...
Namespace Roslyn.Utilities
    Friend Module GeneratedCodeUtilities
        ...
        Friend Function IsGeneratedCode(ByVal tree As SyntaxTree, ByVal isComment As Func(Of SyntaxTrivia, Boolean), ByVal CancelToken As CancellationToken) As Boolean
        ...
        Private Function BeginsWithAutoGeneratedComment(ByVal tree As SyntaxTree, ByVal isComment As Func(Of SyntaxTrivia, Boolean), ByVal CancelToken As CancellationToken) As Boolean
